package test.com.tamark.projecteuler.q0003;
...
import com.tamark.projecteuler.q0003.PrimeFactors;
...
public class PrimeFactorsTest {
	...
	public void testDeterminePrimeFactors() {
		...
		expectedFactors = buildExpectedFactors(0, 0, 1, 0, 1);
		assertTrue("List of prime factors for \"55\" do not match", compareLists(expectedFactors, factors));

		factors = PrimeFactors.determinePrimeFactors(2310);
		expectedFactors = buildExpectedFactors(1, 1, 1, 1, 1);
		assertTrue("List of prime factors for \"2310\" do not match", compareLists(expectedFactors, factors));
	}
